...
const mockCategories: Category[] = [
  { id: '1', name: 'Main Dishes', description: 'Lunch and dinner main courses', itemCount: 12, icon: '🍽️', expandedId: null },
  { id: '2', name: 'Appetizers', description: 'Starters and side dishes', itemCount: 8, icon: '🥗', expandedId: null },
  { id: '3', name: 'Beverages', description: 'Drinks and smoothies', itemCount: 15, icon: '🥤', expandedId: null },
  { id: '4', name: 'Desserts', description: 'Sweet treats and pastries', itemCount: 10, icon: '🍰', expandedId: null },
];

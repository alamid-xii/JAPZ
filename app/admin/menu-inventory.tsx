...
const mockItems: MenuItem[] = [
  { id: '1', name: 'Chicken Adobo', category: 'Main Dishes', price: 250, stock: 45, status: 'available' },
  { id: '2', name: 'Beef Sinigang', category: 'Main Dishes', price: 280, stock: 8, status: 'low' },
  { id: '3', name: 'Iced Tea', category: 'Beverages', price: 75, stock: 0, status: 'out' },
  { id: '4', name: 'Turon', category: 'Desserts', price: 50, stock: 25, status: 'available' },
];
